...
{
    protected $signature = 'app:transcrever {url} {--model=base} {--lang=}';
    ...
    public function handle(): void
    {
        ...
        dispatch(new TranscreverJob($url, $model, $lang));
        logger()->info("[command] Job enfileirado para transcrição do vídeo", ['url' => $url, 'model' => $model, 'lang' => $lang]);
